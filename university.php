...
if(isset($_POST['submit']))
{
	...
	$major = $_POST['major'];
	$cgpa = $_POST['cgpa'];
	$q = mysqli_query($con, "insert into university(degree, institution, year, major, cgpa) 
...
<div class="container">
	...
	<div class="container" style="margin-top: 10px">
		...
		<div class="form-group">
		    ...
		    <label class="radio-inline">
		      <a href="College.php"><input type="radio" name="optradio">College</a>
		    </label>
		    <label class="radio-inline">
