...
if(isset($_POST['submit']))
{
	...
	$major = $_POST['major'];
	$cgpa = $_POST['cgpa'];
	$q = mysqli_query($con, "insert into education(degree, institution, year, major, cgpa) 
	values('$degree', '$institution', '$year', '$major', '$cgpa')");

	if($q){
		header("Location: skillsets.php") ;
	}
	else{
	...
	<div class="container" style="margin-top: 10px">
		...
		<div class="form-group">
		    ...
		    <input type="radio" name="optradio">School
		     ...
		     <label class="radio-inline">
		      <a href="college.php"><input type="radio" name="optradio">College
		      </label></a>
		    <label class="radio-inline">
		      <input type="radio" name="optradio"><a href="university.php">Others</a>
		    </label>
		</div>
	    <div class="form-group">
